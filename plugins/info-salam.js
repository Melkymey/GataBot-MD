...
let bot = `${pickRandom([`*Wa'alaikumussalam"(وعليكم السلام)!! 👉👈
walaikumsalam 🙌*`, `وعليكم السلام 😼`, `*walaikum'salam ? 😸*`])}
`.trim()
...
if (/^Assalamualaikum|assalamualaikum|Assalamu'alaikum|assalamu'alaikum$/i.test(m.text)) {
